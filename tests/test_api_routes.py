...
def test_trade_plan_api_rejects_non_positive_risk_percentage() -> None:
    response = client.post(
        "/trade/plan",
        headers={"X-API-Key": "test-key"},
        json={
...
def test_trade_plan_api_rejects_risk_percentage_above_100() -> None:
    response = client.post(
        "/trade/plan",
        headers={"X-API-Key": "test-key"},
        json={
...
def test_trade_plan_api_rejects_max_position_percentage_above_100() -> None:
    response = client.post(
        "/trade/plan",
        headers={"X-API-Key": "test-key"},
        json={
